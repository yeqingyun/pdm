...
<script src="./include/js/zrprjt/task.js?v=1.0" type="text/javascript"></script>
...
<form>
	<table width="90%">
		...
		<tr>
			<td height="24" width="90" align="center">任务编号：</td><td><input type="text" id="taskNo" name="task.taskNo" size="30" value="<c:out value="${task.taskNo}"/>"/></td>
		...
		<tr>
			...
			<td height="24" width="90" align="center">上级任务：</td><td><input type="text" id="parent" name="task.parent" size="30" value="<c:out value="${task.parent}"/>"/></td>
		</tr>
		<tr>
