...
<form>
	<table width="90%">
		<tr>
			...
			<td height="24" width="90" align="center">公司：</td><td><input type="text" id="comId" name="usr.comId" size="30" value="<c:out value="${usr.comId}"/>"/></td>
		</tr><tr>
			<td height="24" width="90" align="center">部门：</td><td><input type="text" id="deptId" name="usr.deptId" size="30" value="<c:out value="${usr.deptId}"/>"/></td>
