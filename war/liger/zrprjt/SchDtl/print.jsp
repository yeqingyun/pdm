...
<script src="./include/js/zrprjt/schDtl.js" type="text/javascript"></script>
...
<form>
	<table width="90%">
		<tr>
			...
			<td height="24" width="90" align="center">进度ID：</td>
			<td>
			...
			<td height="24" width="90" align="center">状态：</td><td><input type="text" id="status" name="schDtl.status" size="30" value="<c:out value="${schDtl.status}"/>"/></td>
