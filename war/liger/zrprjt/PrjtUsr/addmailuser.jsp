...
$(function(){
	...
	var parentUserIDs = window.parent.document.getElementById("usrIds").value;
	var parentUserNames = window.parent.document.getElementById("usrString").value;
...
function saveMailUser(id) {
	...
	var oldUsrIds;
	var oldUsrString;
	usrIds = $("#usrIds", window.parent.document).val();
	usrString = $("#usrString", window.parent.document).val();
	...
	//协办人
		/* 	window.parent.selectAssistpProjectUserForFlow(usrIds,usrString,userNameIDIt);
			$("#usrIds", window.parent.document).val(usrIds);
			$("#usrString", window.parent.document).val(usrString); */
	$("#usrIds", window.parent.document).val(usrIds);
	$("#usrString", window.parent.document).val(usrString);
