...
<form>
	<table width="90%">
		<tr>
			<td height="24" width="90" align="center">null：</td><td><input type="text" id="msgId" name="taskMsg.msgId" size="30" value="<c:out value="${taskMsg.msgId}"/>"/></td>
			...
			<td height="24" width="90" align="center">null：</td><td><input type="text" id="reply" name="taskMsg.reply" size="30" value="<c:out value="${taskMsg.reply}"/>"/></td>
			...
			<td height="24" width="90" align="center">null：</td><td><input type="text" id="title" name="taskMsg.title" size="30" value="<c:out value="${taskMsg.title}"/>"/></td>
		</tr>
