...
<script type="text/javascript">
	...
	function showDefinDos(){
		...
		function preUploadFile(wfNo,taskId,cateId) {
			...
			var tempPar = '&tempParams='+"wfNo:'1',taskId:1,cateId:1,uploadType:PrjtPointDos"; 
	   		if(prjtNo){
	   		...
	   		var url = gngile_uploadURL
	   		      /**RUL后面跟的参数 **/
	   	  	       ...
	   	  	       //  +'&uploadType='+$("#uploadType" ).val() //文件上传类型 
	   	  	         ...
	   	  	         +'&callBackUrl='+server_URL+"/afterUploadAction!wfPrjtPointAfterUpload.dhtml"//回调的URL,对应你Action中的一个方法，在这个方法里面处理上传完后的业务逻辑
	   		         +tempPar;
	      	...
	      	onclick: function (item, dialog) { dialog.close(); 
	      	  window.location = "./PrjtDef!prjtPointFrameAnnex.shtml?prjtNo="+prjtNo; 
	      	 } } ] });
  ...
  <form id="wfRd-form" name="wfRddoc-form"> 
	...
	<input type="hidden" id="wfDoc.docName" name="wfDoc.docName" size="30" value="<c:out value="${docName}"/>" />
       <div  id = "上传项目进度表 ">
	              ...
	              &nbsp&nbsp&nbsp&nbsp
	              &nbsp&nbsp&nbsp&nbsp
	               <input  type="button" onClick="javascript:preUploadFile('1',1,1);" value="上传项目进度表"> 
	               <br>
	                <!-- <div id="definDos" onMouseout="hidden();"> -->
						    <jsp:include flush="true" page="projtPoint_fileDos.jsp"></jsp:include>
				   <!-- </div> -->
