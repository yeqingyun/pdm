...
$(function () {
	...
	$("#maingrid").ligerGrid({
		columns: [
			...
			{ display: 'null', name: 'btnId', align: 'left', width: 120 }

		],
		checkbox: true,
		rownumbers:true,
		pageSize:20,
		url:'./GpBtn!list.shtml',
		usePager:true,
		width: '99.5%',
		height:'99%',
...
<div id="sform" style="margin:10px;height:70px;">
	<table>
		<tr>
			...
			<td height="24" width="90" align="center">null：</td><td><input type="text" id="nodeId" name="gpBtn.nodeId"/></td>
			<td height="24" width="90" align="center">null：</td>
			<td>
