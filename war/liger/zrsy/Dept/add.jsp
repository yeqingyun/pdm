...
<input type="hidden" id="deptId" name="dept.deptId" size="30" value="<c:out value="${dept.deptId}"/>"/>
	<table width="90%">
		<tr>
			...
			<td height="24" width="90" align="center">级别：</td><td><input type="text" id="leve" name="dept.leve" size="30" value="0" ltype='spinner' ligerui="{type:'int'}" validate="{required:true}"/></td>
			<td align="left"></td>
