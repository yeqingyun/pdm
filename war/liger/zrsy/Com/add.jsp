...
<input type="hidden" id="comId" name="com.comId" size="30" value="<c:out value="${com.comId}"/>"/>
	<table width="90%">
		...
		<tr>
			...
			<td align="left"></td>
			<td height="24" width="90" align="center">级别：</td><td><input type="text" id="leve" name="com.leve" size="30" value="0"  ltype='spinner' ligerui="{type:'int'}" validate="{required:true}"/></td>
			<td align="left"></td>
		</tr>
		<tr>
