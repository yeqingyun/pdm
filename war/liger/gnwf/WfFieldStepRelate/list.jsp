...
$(function () {
	...
	$("#maingrid").ligerGrid({
		...
		rownumbers:true,
		pageSize:20,
		url:'./WfFieldStepRelate!list.shtml',
		usePager:true,
		width: '99.5%',
		height:'99%',
...
<div id="sform" style="margin:10px;height:70px;">
	<table>
		<tr>
			<td height="24" width="90" align="center">null：</td><td><input type="text" id="fieldId" name="wfFieldStepRelate.fieldId"/></td>
			<td height="24" width="90" align="center">null：</td><td><input type="text" id="stepId" name="wfFieldStepRelate.stepId"/></td>
		</tr>
