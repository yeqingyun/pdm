...
<span style="visibility: hidden">页面63jsp</span>
<html>
...
<script type="text/javascript">
	...
	function formatStr1(that,num) {
		var str = $.trim(that.value);
		if(str != null && str != '') {
			if(!isNaN(str)) {
				if(str < 0 || str > num) {					
		    		$.ligerDialog.warn('请输入0到' + num + '之间的正数或0。');
		    		that.value = '';
				} else {
					that.value = parseFloat(str).toFixed(1);
				}	
			} else {
				$.ligerDialog.warn('请输入0到' + num + '之间的正数或0。');
				that.value = '';
		...
		var count = 0;
		if($('.63jspE12').val() != '') {
			count += parseFloat($('.63jspE12').val());
		}
		if($('.63jspE13').val() != '') {
			count += parseFloat($('.63jspE13').val());
		}
		if($('.63jspE14').val() != '') {
			count += parseFloat($('.63jspE14').val());
		}
		if($('.63jspE15').val() != '') {
			count += parseFloat($('.63jspE15').val());
		}
		if($('.63jspE16').val() != '') {
			count += parseFloat($('.63jspE16').val());
		}
		var total = (parseFloat(count) * 0.2).toFixed(1);
		$('.63jspE17').val(total);
	}
	
	function formatStr2(that,num) {
		var str = $.trim(that.value);
		if(str != null && str != '') {
			if(!isNaN(str)) {
				if(str < 0 || str > num) {					
		...
		var count = 0;
		if($('.63jspE23').val() != '') {
			count += parseFloat($('.63jspE23').val());
		}
		if($('.63jspE24').val() != '') {
			count += parseFloat($('.63jspE24').val());
		}
		if($('.63jspE25').val() != '') {
			count += parseFloat($('.63jspE25').val());
		}
		if($('.63jspE26').val() != '') {
			count += parseFloat($('.63jspE26').val());
		}
		if($('.63jspE27').val() != '') {
			count += parseFloat($('.63jspE27').val());
		}
		var total = (parseFloat(count) * 0.4).toFixed(1);
		$('.63jspE28').val(total);
	}
	
	function formatStr3(that,num) {
		var str = $.trim(that.value);
		if(str != null && str != '') {
			if(!isNaN(str)) {
				if(str < 0 || str > num) {					
		...
		var count = 0;
		if($('.63jspE34').val() != '') {
			count += parseFloat($('.63jspE34').val());
		}
		if($('.63jspE35').val() != '') {
			count += parseFloat($('.63jspE35').val());
		}
		if($('.63jspE36').val() != '') {
			count += parseFloat($('.63jspE36').val());
		}
		if($('.63jspE37').val() != '') {
			count += parseFloat($('.63jspE37').val());
		}
		/*if($('.63jspE38').val() != '') {
			count += parseFloat($('.63jspE38').val());
		}*/
		var total = (parseFloat(count) * 0.4).toFixed(1);
		$('.63jspE39').val(total);
	}
...
<body>
	<div id="bodyDiv">
		...
		<br />
		<table border=1 bordercolor=#000000 align=center width=680
			style='font-family: 宋体;border-bottom:0px;'>
			<tr align="center">
				<td width="12%" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;">供应商名称</td>
				<td colspan="3"><c:choose>
						<c:when test="${E1.isEdit == '1'}">
							<B><input type="Text" size="40" maxlength="40"
								AUTOCOMPLETE ="off"
						...
						<c:otherwise>
							<B><input type="Text" size="40"
								...
								style="color:black;font-size: 9.0pt; font-family: 楷体_GB2312;"> </B>
						</c:otherwise>
					</c:choose></td>
			</tr>
			<tr>
				...
				<td colspan="3" align="center"><c:choose>
						<c:when test="${E2.isEdit == '1'}">
							<B><input type="Text" size="40" maxlength="40"
								...
								style="font-size: 9.0pt; font-family: 楷体_GB2312;color:black;"
						...
						<c:otherwise>
							<B><input type="Text" size="40"
								...
								readonly="readonly" disabled="disabled"
								style="font-size: 9.0pt; color:black;font-family: 楷体_GB2312;"> </B>
						</c:otherwise>
					</c:choose></td>
			</tr>
			<tr>
				...
				<td width="35%" align="center"><c:choose>
						<c:when test="${E3.isEdit == '1'}">
							<B><input type="Text" size="25" maxlength="25"
								AUTOCOMPLETE ="off"
						...
						<c:otherwise>
							<B><input type="Text" size="25"
								...
								readonly="readonly" disabled="disabled"
								style="font-size: 9.0pt; font-family: 楷体_GB2312;color:black;"></B>
						</c:otherwise>
					</c:choose></td>
				<td width="12%" align="center" height=21px
				...
				<td width="41%" align="center"><c:choose>
						<c:when test="${E4.isEdit == '1'}">
							<B><input type="Text" size="26" maxlength="26"
								AUTOCOMPLETE ="off"
			...
			<tr>
				...
				<td colspan="3" align="center"><c:choose>
						<c:when test="${E6.isEdit == '1'}">
							<B><input type="Text" size="4" maxlength="4"
								AUTOCOMPLETE ="off"
						...
						<c:otherwise>
							<B><input type="Text" size="4"
								...
								readonly="readonly" disabled="disabled"
								style="font-size: 9.0pt;color:black; font-family: 楷体_GB2312; background-color: #EFF0F2; border-bottom-style: solid; border-top-style: none; border-left-style: none; border-right-style: none;">
							</B>
						</c:otherwise>
					</c:choose> 年&nbsp;&nbsp; <c:choose>
						<c:when test="${E7.isEdit == '1'}">
							<B><input type="Text" size="3" maxlength="3"
								AUTOCOMPLETE ="off"
			...
			<tr>
				...
				<td width="35%" align="center" style="border-bottom:0px;"><c:choose>
						<c:when test="${E10.isEdit == '1'}">
							<B><input type="Text" size="17" maxlength="17"
								AUTOCOMPLETE ="off"
				...
				<td width="41%" align="center" style="border-bottom:0px;"><c:choose>
						<c:when test="${E11.isEdit == '1'}">
							<B><input type="Text" size="38" maxlength="38"
								AUTOCOMPLETE ="off"
		...
		<table border=1 bordercolor=#000000 align=center width=680
			...
			<tr>
				<td width="12%" align="center" valign="middle" height=22px
					style="font-size: 10.0pt; font-family: 宋体;">审查项目</td>
				<td width="76%" align="center" valign="middle" height=22px
					style="font-size: 10.0pt; font-family: 宋体;">主要内容</td>
				<td width="5%" align="center" valign="middle" height=22px
					style="font-size: 10.0pt; font-family: 宋体;">分值</td>
				<td width="7%" align="center" valign="middle" height=22px
					style="font-size: 10.0pt; font-family: 宋体;">得分</td>				
			</tr>
			<tr>
				<td width="12%" rowspan="5" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;">管理体系<br>(20分)</td>
				<td width="76%" align="left" height=21px
					style="font-size: 10.0pt; font-family: 宋体; padding:1px;">1、是否通过ISO9001质量体系或产品认证、每年是否有例行监督审核、证书是否有效？</td>
				<td width="5%" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;">15</td>
				<td width="7%" align="center" height=21px
			...
			<tr>
				<td width="76%" align="left" height=21px
					style="font-size: 10.0pt; font-family: 宋体; padding:1px;">2、公司各职能是否健全、各部门职责是否明确？</td>
				<td width="5%" align="center" height=21px
			...
			<tr>
				<td width="76%" align="left" height=21px
					style="font-size: 10.0pt; font-family: 宋体; ">3、质量管理体系所需过程策划是否完整、每个过程是否有相应的文件支持？技术类文件是否健全？ </td>
				<td width="5%" align="center" height=21px
			...
			<tr>
				<td width="76%" align="left" height=21px
					style="font-size: 10.0pt; font-family: 宋体; padding:1px;">4、质量目标设定是否合理、质量目标是否有监控？ </td>
				<td width="5%" align="center" height=21px
			...
			<tr>
				<td width="76%" align="left" height=21px
					style="font-size: 10.0pt; font-family: 宋体; padding:1px;">5、是否按规定的时间进行内部审核和管理评审、是否建立/保持持续改进的措施？</td>
				<td width="5%" align="center" height=21px
			...
			<tr>
				<td width="88%" colspan="2" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;">得分</td>
				<td width="12%" colspan="2" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;"><c:choose>
						<c:when test="${E17.isEdit == '1'}">
							<B><input type="Text" size="4" maxlength="4"
								...
								style="font-size: 9.0pt; font-family: 楷体_GB2312;"
								name="fieldContents[<c:out value="${E17.count}"/>].fieldText" class="63jspE17" readonly="readonly" 
				...
				基于以下:
					...
					<c:choose>
						<c:when test="${E19.isEdit == '1'}">
							<B><input type="Text" size="110" maxlength="70"
								AUTOCOMPLETE ="off" 
					...
					<c:choose>
						<c:when test="${E20.isEdit == '1'}">
							<B><input type="Text" size="63" maxlength="70"
								AUTOCOMPLETE ="off"
					...
					<font style="color:black;font-size: 9.0pt; font-family: 宋体;">签名:</font> <c:choose>
						...
						<c:otherwise>
							<B><input type="Text" size="12"
								...
								disabled="disabled"
								style="color:black;font-size: 9.0pt; font-family: 楷体_GB2312; border-bottom-style: solid; border-top-style: none; border-left-style: none; border-right-style: none;">
							</B>
						</c:otherwise>
			...
			<tr>
				...
				<td width="76%" align="left" height=21px
					style="font-size: 10.0pt; font-family: 宋体; padding:1px;">1、品质人员配置是否合理、检验与试验仪器设备是否齐全？</td>
				<td width="5%" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;">20</td>
				<td width="7%" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;"><c:choose>
			...
			<tr>
				<td width="76%" align="left" height=21px
					style="font-size: 10.0pt; font-family: 宋体; padding:1px;">2、关键器件检验与试验项目/方法/设备是否满足要求、是否按照既定的抽样方案进行检验与试验？</td>
				<td width="5%" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;">20</td>
				<td width="7%" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;"><c:choose>
			...
			<tr>
				<td width="76%" align="left" height=21px
					style="font-size: 10.0pt; font-family: 宋体; padding:1px;">3、生产制程是否有关键品质控制点（检测）并进行监控、是否实施首件确认？</td>
				<td width="5%" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;">10</td>
				<td width="7%" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;"><c:choose>
			...
			<tr>
				<td width="76%" align="left" height=21px
					style="font-size: 10.0pt; font-family: 宋体; padding:1px;">4、成品检验与试验项目/方法/设备是否满足要求、是否按照既定的抽样方案进行检验与试验？ </td>
				<td width="5%" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;">20</td>
				<td width="7%" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;"><c:choose>
			...
			<tr>
				<td width="76%" align="left" height=21px
					style="font-size: 10.0pt; font-family: 宋体; padding:1px;">5、生产关键过程/工序是否有工艺/作业标准、是否按要求执行、关键过程/工序参数是否监控？</td>
				<td width="5%" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;">30</td>
				<td width="7%" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;"><c:choose>
					...
					style="font-size: 10.0pt; font-family: 宋体;"><c:choose>
						<c:when test="${E28.isEdit == '1'}">
							<B><input type="Text" size="4" maxlength="4"
								...
								style="font-size: 9.0pt; font-family: 楷体_GB2312;"
								name="fieldContents[<c:out value="${E28.count}"/>].fieldText" class="63jspE28" readonly="readonly"
					...
					<font style="font-size: 9.0pt; font-family: 宋体;">签名:</font> <c:choose>
						...
						<c:otherwise>
							<B><input type="Text" size="12"
								...
								disabled="disabled"
								style="font-size: 9.0pt; color:black;font-family: 楷体_GB2312; border-bottom-style: solid; border-top-style: none; border-left-style: none; border-right-style: none;">
							</B>
						</c:otherwise>
					</c:choose> &nbsp;<font style="font-size: 9.0pt; font-family: 宋体;">日期:</font>
					<c:choose>
			...
			<tr>
				...
				<td width="76%" align="left" height=21px
					style="font-size: 10.0pt; font-family: 宋体; padding:1px;">1、公司产品设计开发职能/部门人员配置是否充分、测试仪器设备是否齐全？</td>
				<td width="5%" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;">25</td>
				<td width="7%" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;"><c:choose>
			...
			<tr>
				<td width="76%" align="left" height=21px
					style="font-size: 10.0pt; font-family: 宋体; padding:1px;">2、公司生产环境是否能满足要求、工艺规划/布局是否合理、生产设备是否满足？</td>
				<td width="5%" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;">25</td>
				<td width="7%" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;"><c:choose>
			...
			<tr>
				<td width="76%" align="left" height=21px
					style="font-size: 10.0pt; font-family: 宋体; padding:1px;">3、是否有产品/零部件技术规格书、是否对产品进行测试/认证、测试/认证是否充分？</td>
				<td width="5%" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;">20</td>
				<td width="7%" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;"><c:choose>
			...
			<tr>
				<td width="76%" align="left" height=21px
					style="font-size: 10.0pt; font-family: 宋体; padding:1px;">4、生产关键过程/工序是否有工艺/作业标准、是否有效执行、关键过程/工序参数是否监控？</td>
				<td width="5%" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;">30</td>
				<td width="7%" align="center" height=21px
					style="font-size: 10.0pt; font-family: 宋体;"><c:choose>
					...
					style="font-size: 10.0pt; font-family: 宋体;"><c:choose>
						<c:when test="${E39.isEdit == '1'}">
							<B><input type="Text" size="4" maxlength="4"
								...
								style="font-size: 9.0pt; font-family: 楷体_GB2312;"
								name="fieldContents[<c:out value="${E39.count}"/>].fieldText" class="63jspE39" readonly="readonly"
					...
					<c:choose>
						...
						<c:otherwise>
							<B><input type="Text" size="110"
								...
								readonly="readonly" disabled="disabled"
								style="font-size: 9.0pt; font-family: 楷体_GB2312; background-color: #EFF0F2; border-bottom-style: solid; border-top-style: none; border-left-style: none; border-right-style: none;color:black;">
							</B>
						</c:otherwise>
					</c:choose><br> 
					<c:choose>
						...
						<c:otherwise>
							<B><input type="Text" size="63"
								...
								readonly="readonly" disabled="disabled"
								style="color:black;font-size: 9.0pt; font-family: 楷体_GB2312; background-color: #EFF0F2; border-bottom-style: solid; border-top-style: none; border-left-style: none; border-right-style: none;">
							</B>
						</c:otherwise>
					</c:choose>
					<span style="width:26px;display:inline-block;"></span>
			...
			<tr>
				...
				<td width="88%" colspan="3" align="left" height=21px
					...
					<font style="font-size: 9.0pt; font-family: 宋体;">1、公司主要客户：</font> <c:choose>
						<c:when test="${E45.isEdit == '1'}">
							<B><input type="Text" size="69" maxlength="69"
								AUTOCOMPLETE ="off"
				...
				<td width="88%" colspan="3" align="left" height=21px
					...
					<font style="font-size: 9.0pt; font-family: 宋体;">2、公司上年度营业额（万元）：</font> <c:choose>
						<c:when test="${E46.isEdit == '1'}">
							<B><input type="Text" size="59" maxlength="59"
								AUTOCOMPLETE ="off"
				...
				<td width="88%" colspan="3" align="left" height=21px
					...
					<font style="font-size: 9.0pt; font-family: 宋体;">3、行业地位：</font> <c:choose>
						<c:when test="${E47.isEdit == '1'}">
							<B><input type="Text" size="46" maxlength="46"
								AUTOCOMPLETE ="off"
				...
				<td width="88%" colspan="3" align="left" height=21px
					...
					<font style="font-size: 9.0pt; font-family: 宋体;">3、与一级供应商合作情况：</font> <c:choose>
						<c:when test="${E48.isEdit == '1'}">
							<B><input type="Text" size="62" maxlength="62"
								AUTOCOMPLETE ="off"
				...
				<td width="88%" colspan="3" align="left" height=21px
					...
					<font style="font-size: 9.0pt; font-family: 宋体;">4、其上游供应商的支持：</font> <c:choose>
						<c:when test="${E49.isEdit == '1'}">
							<B><input type="Text" size="64" maxlength="64"
								AUTOCOMPLETE ="off"
				...
				<td width="88%" colspan="3" align="left" height=21px
					...
					<font style="font-size: 9.0pt; font-family: 宋体;">5、产能情况：</font> <c:choose>
						<c:when test="${E50.isEdit == '1'}">
							<B><input type="Text" size="72" maxlength="72"
								AUTOCOMPLETE ="off"
				...
				商务意见:
					<c:choose>
						<c:when test="${E51.isEdit == '1'}">
							<B><input type="Text" size="99" maxlength="84"
								AUTOCOMPLETE ="off"
					...
					<font style="font-size: 9.0pt; font-family: 宋体;">签名:</font> <c:choose>
						...
						<c:otherwise>
							<B><input type="Text" size="12"
								...
								disabled="disabled"
								style="font-size: 9.0pt; font-family: 楷体_GB2312;color:black; border-bottom-style: solid; border-top-style: none; border-left-style: none; border-right-style: none;">
							</B>
						</c:otherwise>
					</c:choose> &nbsp;<font style="font-size: 9.0pt; font-family: 宋体;">日期:</font>
					<c:choose>
				...
				<td width="88%" colspan="3" valign="top" style="font-size: 10.0pt; font-family: 宋体;">
					<p style="font-size: 10.0pt; font-family: 宋体;">
						...
						<c:when test="${E57.isEdit == '1'}">
							<b><input type="Text" size="95" maxlength="82"
								AUTOCOMPLETE ="off"
						...
						<c:when test="${E58.isEdit == '1'}">
							<b><input type="Text" size="41" maxlength="70"
								AUTOCOMPLETE ="off"
				...
				<td width="88%" colspan="3" valign="top" style="font-size: 10.0pt; font-family: 宋体;">
					...
					<c:choose>
						<c:when test="${E61.isEdit == '1'}">
							<b><input type="Text" size="78.5" maxlength="68"
								AUTOCOMPLETE ="off"
						...
						<c:when test="${E62.isEdit == '1'}">
							<b><input type="Text" size="96.5" maxlength="80"
								AUTOCOMPLETE ="off"
			...
			<tr>
				...
				<td width="88%" colspan="3" valign="top" style="font-size: 10.0pt; font-family: 宋体; padding:1px;">					
					...
					<c:when test="${E65.isEdit == '1'}">
						...
						<label for="E65_3">不合格，不选为二级供应商<br></label>
					...
					<c:otherwise>					
						...
						<label for="E65_1">合格，可作为二级供应商<br></label>
				...
				<div align="right">
					<span style="width:286px;display:inline-block;"></span>
					<font style="font-size: 9.0pt; font-family: 宋体;">签名:</font> <c:choose>
		...
		<table width="680" border="0" align="center" style="">
			<tr>
