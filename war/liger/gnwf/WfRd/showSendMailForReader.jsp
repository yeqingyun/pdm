		...
		<input type="hidden" id="wfRd.wfNo" name="wfRd.wfNo" value="<c:out value="${wfRd.wfNo}"/>">
			<table width="90%">
					...
					<tr>
						...
						<td bgcolor="#ffffff" width="70%" height="24"><input
							type="text" id="usrString" name="usrString"
							value="<c:out value="${usrString}"/>"
							style="width: 600px; height: 18px" readonly="true" /> <input
							type="button" value="选择接收人" onclick="selectPrjtUsers();"></input></td>
					</tr>
					<%-- <tr bgcolor="#ffffff">
						<td width="20%" align="center">抄送人：</td>
						<td bgcolor="#ffffff" width="70%" height="24"><input
							type="text" id="usrStringForCC" name="usrStringForCC"
							value="<c:out value="${usrString}"/>"
							style="width: 600px; height: 18px" readonly="true" /> <input
							type="button" value="选择接收人" onclick="selectPrjtUsers();"></input></td>
					</tr> --%>
					</tr>
				<tr><td></td><td align="right"><input type="button" value="发送" onclick="sendEmail1();" ></input></td></tr>
			</table>
		</form>
	</div>
