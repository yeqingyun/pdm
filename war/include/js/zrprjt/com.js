...
function sea() {
	gridManager.setOptions({
		parms: [
			{name: 'com.comId', value: $("#comId").val()},
			{name: 'com.parent', value: $("#parent").val()},
			{name: 'com.leve', value: $("#leve").val()},
			{name: 'com.status', value: $("#status").val()},
			{name: 'com.createBy', value: $("#createBy").val()},
			{name: 'com.lastUpd', value: $("#lastUpd").val()},
			{name: 'com.startCreateDate', value: $("#startCreateDate").val()},
			{name: 'com.endCreateDate', value: $("#endCreateDate").val()},
			{name: 'com.startLastDate', value: $("#startLastDate").val()},
			{name: 'com.endLastDate', value: $("#endLastDate").val()},
			{name: 'com.comNo', value: $("#comNo").val()},
			{name: 'com.comNm', value: $("#comNm").val()},
			{name: 'com.remark', value: $("#remark").val()}
	...
	$.ligerDialog.confirm('确定要保存记录？', 
		function (type) { 
			if(type) {
				...
				str += '"com.createBy":"'+$("#createBy").val()+'",';
				str += '"com.lastUpd":"'+$("#lastUpd").val()+'",';
				str += '"com.createDate":"'+$("#createDate").val()+'",';
				str += '"com.lastDate":"'+$("#lastDate").val()+'",';
