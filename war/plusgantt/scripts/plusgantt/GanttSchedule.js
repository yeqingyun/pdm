            ...
            switch (field) {
                case "Duration":
                    ...
                    if (task.Start) {
                        ...
                        task.Finish.setDate(Number(task.Finish.getDate()) + Number(task.Duration) - 1);
                ...
                case "Start":
                    ...
                    if (task.Start) {
                        task.Finish = maxTime(task.Start);
                        task.Finish.setDate(Number(task.Start.getDate()) + Number(task.Duration) - 1);
                ...
                case "Finish":
                    ...
                    if (task.Finish && task.Start) {
                        var days = parseInt((Number(task.Finish) - Number(task.Start)) / (3600 * 24 * 1000));
