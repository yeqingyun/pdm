...
public class BasicUsr {
	public static final String SELF_FIELDS = "Usr.Id,Usr.ComId,Usr.DeptId,Usr.OrgNo,Usr.Status,Usr.CreateBy,Usr.LastUpd,Usr.CreateDate,Usr.LastDate,Usr.Login,Usr.Pwd,Usr.UsrNo,Usr.UsrName,Usr.Email,Usr.Remark";
