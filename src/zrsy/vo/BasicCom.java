...
public class BasicCom {
	public static final String SELF_FIELDS = "Com.ComId,Com.Leve,Com.Status,Com.CreateBy,Com.LastUpd,Com.CreateDate,Com.LastDate,Com.ComNo,Com.ComNm,Com.Remark";
