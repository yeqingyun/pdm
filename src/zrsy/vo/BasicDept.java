...
public class BasicDept {
	public static final String SELF_FIELDS = "Dept.DeptId,Dept.Parent,Dept.Leve,Dept.Status,Dept.CreateBy,Dept.LastUpd,Dept.CreateDate,Dept.LastDate,Dept.DeptNo,Dept.DeptNm,Dept.Remark";
